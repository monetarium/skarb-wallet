...
// NOTE: VSPTicketInfo / TicketMaturity / TicketExpiry / AutoTicketsBuyerConfig
// stubs were removed here — the real implementations are restored in ticket.go
// now that the staking section is back.
