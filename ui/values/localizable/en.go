...
"directBuyWarning" = "The wallet must stay online to vote. Skarb Wallet itself does not vote yet — voting requires a voting-enabled node running with this seed. An unvoted ticket expires and is revoked without reward."
