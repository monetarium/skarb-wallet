...
"legacyHDCoinType" = "Legacy HD path (coin type 42)"
"legacyHDCoinTypeInfo" = "Mainnet only. Default is coin type 9508 (m/44'/9508'/…). Enable only to recover a wallet that already used the old path m/44'/42'/…"
