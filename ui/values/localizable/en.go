...
"abstain" = "Abstain"
"account" = "Account"
"accountList" = "UTXO List"
"accountMixer" = "AccountMixer"
"accRenamed" = "Account renamed"
"acctCreated" = "Account created"
"asset" = "Asset"
"allAssets" = "All assets"
"wipeNetworkState" = "Wipe network state"
"wipeNetworkStateBody" = "This deletes the entire local %s datadir (block headers, peer cache, every wallet in this network and its database). The app will exit; relaunch it to start fresh and restore wallets from seed.\n\nMake sure all seeds for wallets on this network are backed up. There is no undo."
"expectedAsset" = "Expected asset"
"sameAddressReceivesHint" = "Same address receives any active asset. Tell the sender to deposit %s."
...
"autoTicketInfo" = "Skarb Wallet must remain running, for tickets to be automatically purchased"
"autoTicketEnabled" = "Auto ticket purchase is enabled."
"autoTicketMobileInfo" = "Tickets are only purchased while Skarb Wallet is open on screen — the system pauses apps in the background"
"scanQRHint" = "Point the camera at the QR code"
"scannerUnavailable" = "Camera is unavailable"
"stakeStatusOff" = "Auto-buy is not configured. Turn on «Auto-staking» to configure — your password is required."
"stakeStatusPaused" = "Auto-buy is configured (reserve %s) but paused after restart. Turn on «Auto-staking» to resume — your password is required."
"stakeStatusDisabled" = "Auto-buy is configured (%s in reserve), but currently disabled. Turn on «Auto-staking» to enable — your password is required."
"stakeStatusActive" = "Auto-buy is on. The reserve %s stays untouched; the rest buys tickets."
"stakeStatusLowBalance" = "Auto-buy is on, but the balance is too low for a ticket (price %s VAR). Top up the wallet — tickets are bought automatically."
"balToMaintainHint" = "Reserve: how much VAR to keep untouched. The rest (balance − reserve) is spent on tickets, one per network ticket price."
"autoStaking" = "Auto-staking"
"buyTickets" = "Buy tickets"
"numberOfTickets" = "Number of tickets"
"manualStakeHint" = "One-time purchase: you choose how many tickets and pay now. Unlike auto-staking, it does not need the app to stay open."
"confirmManualPurchase" = "Confirm ticket purchase"
"ticketsPurchased" = "Purchased %d ticket(s)."
"insufficientForTickets" = "Not enough funds: need %[1]s, available %[2]s."
"purchasingTickets" = "Purchasing tickets…"
...
"balToMaintain" = "Balance to maintain (VAR)"
...
"crossPlatformSubtext" = "Skarb runs on macOS, Windows and Linux from a single codebase."
"createOrRestoreToSeeBalances" = "Create or restore a Monetarium wallet to see VAR and SKA balances here."
...
"destinationLabelAddress" = "Destination Address"
"destinationLabelWallet" = "Destination Wallet"
"destinationLabelAccount" = "Destination Account"
...
"dexResetInfo" = "You may need to restart Skarb before you can use the DEX again. Proceed?"
...
"hdPath" = "HD Path"
"help" = "Help"
"helpInfo" = "For more information about Skarb, visit the Monetarium documentation."
"hex" = "Hex"
...
"insufficientFundForFee" = "Not enough to cover the network fee — tap Max to send the full balance, or subtract the fee from the recipient"
...
"integratedExchangeFunctionality" = "Integrated ecosystem"
"integratedExchangeSubtext" = "Securely store VAR (Varta) and SKA (Skarb) coins in a single app."
...
"liveInfoDisc" = "revoke in %v of %v blocks (%v)"
...
"multiWalletSubtext" = "Send and receive VAR and SKA on the Monetarium network."
...
"online" = "Online, "
"agendaActive" = "Active"
"agendaDefined" = "Defined"
"agendaFailed" = "Failed"
"agendaLockedIn" = "Locked in"
"agendaStarted" = "Started"
...
"orderSchedulerInfo" = "Monetarium must remain running, for orders to be automatically executed"
...
"pending" = "Pending"
"pendingByVSP" = "Pending by VSP"
"waitingForSplit" = "Waiting for Split"
...
"rebroadcastLimitExceeded" = "You have exceeded the maximum number of rebroadcasts. Please try again in %d min."
"subtractFeeFromRecipient" = "Subtract fee from recipient amount"
"subtractFeeFromRecipientToggle" = "Take the fee from the recipient"
"subtractFeeFromRecipientDesc" = "Unchecked — you (the sender) pay the network fee on top of the entered amount: the recipient receives exactly the entered amount. Checked — the fee is subtracted from the recipient's amount: you spend exactly the entered amount and the recipient receives it minus the fee."
"rescan" = "Rescan"
...
"txStatusConfirming"      = "(%v of %v confirmations)" 
"type" = "Type"
...
"voteUpdatedLocallyOnly" = "Vote choice saved in this wallet. It was not sent to the VSP, so tickets held by the VSP keep voting the previous choice until you unlock the wallet and change it again."
"voteUpdating" = "A vote choice is already being saved"
"confirmVoteChoiceVSP" = "Send vote choice to the VSP"
"voteChoiceVSPUnlock" = "Some of your tickets are managed by a VSP. Enter your spending password so the new choice can be sent there — otherwise those tickets keep voting the previous choice."
"voting" = "Voting"
...
"vspAPI" = "VSP API"
"vspFee" = "VSP Fee"
"vspFeeUnpaid" = "Not paid"
"vspFeeErrored" = "Fee payment failed"
"removeVSP" = "Remove VSP"
"removeVSPWarn" = "Remove %s from the VSP list?"
...
"welcomeNote" = "Welcome to Skarb Wallet for the Monetarium network."
...
"stakingTx" = "Staking Activities"
"rewardTx" = "Reward Transactions"
"pow" = "PoW"
"pos" = "PoS"
"powReward" = "Miner reward"
"posReward" = "Staker reward"
"allRewards" = "All rewards"
"powRewards" = "Miner rewards"
"posRewards" = "Staker rewards"
"directBuy" = "Direct buy (solo)"
"directBuyWarning" = "In Solo mode, you just buy tickets in Skarb Wallet. Skarb itself does not vote. Voting is done by the node wallet with the same seed phrase, which must stay online. If it is offline when it is time to vote, the stake is returned and no reward is paid."
"allWithoutSplit" = "All without Split"
"allTypes" = "All types"
"daysToExpire" = "%dd to Expire"
"minerCoinbase" = "Miner Coinbase"
"minerFee" = "Miner Fee"
...
"filter" = "Filter"
"export" = "Export"
"integratedExchange" = "Integrated ecosystem"
...
"appRestartToApply" = "Your app will restart to apply this change. Continue?"
"dateAtTime" = "%s at %s"
"imminent" = "imminent"
"unsupportedWallet" = "(unsupported wallet: %s)"
"balanceError" = "balance error: %v"
...
"legacyHDCoinTypeInfo" = "Use only to recover a wallet that already spent on m/44'/42'/…"
...
// Custom-fee feature (send page advanced options). The %s placeholders
// arrive pre-formatted via FormatTxAmountBig as "X.YZ SKA1" / "X.YZ VAR",
// so the template doesn't repeat the unit — append "per KB" once at the end.
"customFeeTitle" = "Custom Fee"
"feeRatePerKbHint" = "Fee rate per KB"
"feeRateBounds" = "Range: %s — %s per KB"
"currentFeeRateAuto" = "Current rate (auto): %s per KB"
"currentFeeRateCustom" = "Current rate (custom): %s per KB"
"apply" = "Apply"
"customFeeApplied" = "Rate applied: %s per KB. Estimated fee: %s (≈ rate × tx size)"
"customFeeTooHigh" = "Rate %s per KB produces a fee larger than your spendable balance for this coin. Lower the rate."
"customFeeCleared" = "Fee rate cleared (network default will be used)"
"feeRateBelowMin" = "Rate %s is below the network minimum (%s per KB)"
"feeRateAboveMax" = "Rate %s exceeds the safety cap (%s per KB)"
"feeRateNotSupported" = "Custom fee is not supported for this coin type"
`
