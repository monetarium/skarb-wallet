...
"autoTicketInfo" = "Monetarium must remain running, for tickets to be automatically purchased"
"autoTicketInsufficient" = "Auto ticket purchase is enabled, but the balance is too low to buy a ticket — one ticket costs %s VAR. Top up the wallet and a ticket will be purchased automatically."
"stakeStatusOff" = "Auto ticket purchase is off. Turn on «Stake» to set it up."
"stakeStatusPaused" = "Auto-buy is configured (reserve %s) but paused after restart. Turn on «Stake» to resume — your password is required."
