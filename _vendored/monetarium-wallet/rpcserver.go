...
func generateAuthority(pub, priv any) (*ClientCA, error) {
	...
	template := &x509.Certificate{
		...
		Subject: pkix.Name{
			CommonName:         "monw",
			Organization:       []string{"monw"},
			OrganizationalUnit: []string{"monw certificate authority"},
		},
...
func createSignedClientCert(pub, caPriv any, ca *x509.Certificate) ([]byte, error) {
	...
	template := &x509.Certificate{
		...
		Subject: pkix.Name{
			CommonName:         "monw",
			Organization:       []string{"monw"},
			OrganizationalUnit: []string{"monw client certificate"},
		},
	}
