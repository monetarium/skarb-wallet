...
// processes to communicate with and and manage the lifetime of a monetarium-wallet
...
// message, shutdown begins.  This prevents monetarium-wallet from continuing to run
...
// for a child monetarium-wallet process to communicate with a parent process without the
