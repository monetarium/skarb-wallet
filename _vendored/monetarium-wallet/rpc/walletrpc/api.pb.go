...
type TransactionDetails struct {
	...
	Fee             string                             `protobuf:"bytes,5,opt,name=fee,proto3" json:"fee,omitempty"`              // VAR or SKA atoms (decimal string)
...
func (x *TransactionDetails) GetFee() string {
	if x != nil {
		return x.Fee
	}
	return ""
...
type FundTransactionRequest struct {
	...
	// coin_type selects the coin to fund (0=VAR, 1-255=SKA). Default 0
	// preserves prior VAR-only behaviour for clients that have not adopted
	// the field yet.
...
func (x *FundTransactionRequest) GetCoinType() uint32 {
	if x != nil {
		return x.CoinType
	}
	return 0
...
type UnspentOutputsRequest struct {
	...
	RequiredConfirmations    int32                  `protobuf:"varint,3,opt,name=required_confirmations,json=requiredConfirmations,proto3" json:"required_confirmations,omitempty"`
	IncludeImmatureCoinbases bool                   `protobuf:"varint,4,opt,name=include_immature_coinbases,json=includeImmatureCoinbases,proto3" json:"include_immature_coinbases,omitempty"`
	// coin_type selects the coin to enumerate (0=VAR, 1-255=SKA). Default 0
	// preserves prior VAR-only behaviour for clients that have not adopted
	// the field yet.
	CoinType      uint32 `protobuf:"varint,5,opt,name=coin_type,json=coinType,proto3" json:"coin_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UnspentOutputsRequest) GetCoinType() uint32 {
	if x != nil {
		return x.CoinType
	}
	return 0
...
type ConstructTransactionRequest struct {
	...
	RequiredConfirmations int32                  `protobuf:"varint,2,opt,name=required_confirmations,json=requiredConfirmations,proto3" json:"required_confirmations,omitempty"`
	// Per-kB relay fee override (decimal-string atoms) for the inferred
	// coin type. When empty or zero, the wallet falls back to its
	// configured RelayFeeForCoinType.
	FeePerKb                 string                                               `protobuf:"bytes,3,opt,name=fee_per_kb,json=feePerKb,proto3" json:"fee_per_kb,omitempty"`
...
func (x *ConstructTransactionRequest) GetFeePerKb() string {
	if x != nil {
		return x.FeePerKb
	}
	return ""
...
type ConstructTransactionResponse struct {
	...
	// VAR or SKA atoms (decimal string).
	TotalPreviousOutputAmount string `protobuf:"bytes,2,opt,name=total_previous_output_amount,json=totalPreviousOutputAmount,proto3" json:"total_previous_output_amount,omitempty"`
	TotalOutputAmount         string `protobuf:"bytes,3,opt,name=total_output_amount,json=totalOutputAmount,proto3" json:"total_output_amount,omitempty"`
...
func (x *ConstructTransactionResponse) GetTotalPreviousOutputAmount() string {
	if x != nil {
...
func (x *ConstructTransactionResponse) GetTotalOutputAmount() string {
	if x != nil {
...
type SweepAccountRequest struct {
	...
	// Per-kB relay fee override (decimal-string atoms). When empty or
	// zero, the wallet falls back to RelayFeeForCoinType.
	FeePerKb string `protobuf:"bytes,4,opt,name=fee_per_kb,json=feePerKb,proto3" json:"fee_per_kb,omitempty"`
	// coin_type selects the coin to sweep (0=VAR, 1-255=SKA). Default 0
	// preserves the prior VAR-only behavior. UTXOs not matching coin_type
	// are skipped.
	CoinType      uint32 `protobuf:"varint,5,opt,name=coin_type,json=coinType,proto3" json:"coin_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SweepAccountRequest) GetFeePerKb() string {
	if x != nil {
		return x.FeePerKb
	}
	return ""
...
func (x *SweepAccountRequest) GetCoinType() uint32 {
	if x != nil {
		return x.CoinType
	}
	return 0
...
func (x *SweepAccountResponse) GetTotalPreviousOutputAmount() string {
	if x != nil {
		return x.TotalPreviousOutputAmount
	}
	return ""
...
func (x *SweepAccountResponse) GetTotalOutputAmount() string {
	if x != nil {
		return x.TotalOutputAmount
	}
	return ""
...
type TransactionDetails_Input struct {
	...
	PreviousAmount  string                 `protobuf:"bytes,3,opt,name=previous_amount,json=previousAmount,proto3" json:"previous_amount,omitempty"` // VAR or SKA atoms (decimal string)
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *TransactionDetails_Input) GetPreviousAmount() string {
	if x != nil {
...
type TransactionDetails_Output struct {
	...
	Amount        string                 `protobuf:"bytes,4,opt,name=amount,proto3" json:"amount,omitempty"` // VAR or SKA atoms (decimal string)
...
func (x *TransactionDetails_Output) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
type AccountsResponse_Account struct {
	...
	AccountNumber uint32                 `protobuf:"varint,1,opt,name=account_number,json=accountNumber,proto3" json:"account_number,omitempty"`
	AccountName   string                 `protobuf:"bytes,2,opt,name=account_name,json=accountName,proto3" json:"account_name,omitempty"`
	// total_balance is VAR atoms only (1e8/coin). It used to also include
	// SKA, but VAR atoms and SKA atoms (1e18/coin) are not summable into
	// a single int64. SKA balances are reported per coin type in
	// ska_total_balances below.
	...
	// ska_total_balances reports confirmed SKA balances for this account
	// keyed by SKA coin type (1-255). Values are big.Int atoms in base-10
	// decimal string form (SKA uses 1e18 atoms/coin, which exceeds int64
	// range). Zero-balance coin types are omitted.
	SkaTotalBalances map[uint32]string `protobuf:"bytes,9,rep,name=ska_total_balances,json=skaTotalBalances,proto3" json:"ska_total_balances,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AccountsResponse_Account) GetSkaTotalBalances() map[uint32]string {
	if x != nil {
		return x.SkaTotalBalances
	}
	return nil
}
...
type ConstructTransactionRequest_Output struct {
	...
	// VAR or SKA atoms (decimal string). For SKA outputs set coin_type
	// to 1-255; all outputs in a single request must share the same
	// coin_type.
...
func (x *ConstructTransactionRequest_Output) GetAmount() string {
	if x != nil {
		return x.Amount
	}
	return ""
...
func (x *ConstructTransactionRequest_Output) GetCoinType() uint32 {
	if x != nil {
		return x.CoinType
	}
	return 0
...
const file_api_proto_rawDesc = "" +
	...
	"\x0fprevious_amount\x18\x03 \x01(\tR\x0epreviousAmount\x1a\xab\x01\n" +
	"\x06Output\x12\x14\n" +
	...
	"\x14current_block_height\x18\x03 \x01(\x05R\x12currentBlockHeight\x1a\x88\x04\n" +
	"\aAccount\x12%\n" +
	...
	"\x10account_unlocked\x18\b \x01(\bR\x0faccountUnlocked\x12g\n" +
	"\x12ska_total_balances\x18\t \x03(\v29.walletrpc.AccountsResponse.Account.SkaTotalBalancesEntryR\x10skaTotalBalances\x1aC\n" +
	"\x15SkaTotalBalancesEntry\x12\x10\n" +
	...
	"\x18ChangePassphraseResponse\"\x9d\x02\n" +
	...
	"\x15include_change_script\x18\x05 \x01(\bR\x13includeChangeScript\x12\x1b\n" +
	"\tcoin_type\x18\x06 \x01(\rR\bcoinType\"\xb6\x03\n" +
	...
	"\x04tree\x18\a \x01(\x05R\x04tree\"\xe8\x01\n" +
	"\x15UnspentOutputsRequest\x12\x18\n" +
	"\aaccount\x18\x01 \x01(\rR\aaccount\x12#\n" +
	"\rtarget_amount\x18\x02 \x01(\x03R\ftargetAmount\x125\n" +
	"\x16required_confirmations\x18\x03 \x01(\x05R\x15requiredConfirmations\x12<\n" +
	"\x1ainclude_immature_coinbases\x18\x04 \x01(\bR\x18includeImmatureCoinbases\x12\x1b\n" +
	"\tcoin_type\x18\x05 \x01(\rR\bcoinType\"\x95\x02\n" +
	...
	"\n" +
	"amount_sum\x18\b \x01(\x03R\tamountSum\"\x9e\x06\n" +
	...
	"\n" +
	"fee_per_kb\x18\x03 \x01(\tR\bfeePerKb\x12}\n" +
	...
	"\x0escript_version\x18\x03 \x01(\rR\rscriptVersion\x1a\x99\x01\n" +
	"\x06Output\x12Z\n" +
	...
	"\tcoin_type\x18\x03 \x01(\rR\bcoinType\"4\n" +
	...
	"\x1ctotal_previous_output_amount\x18\x02 \x01(\tR\x19totalPreviousOutputAmount\x12.\n" +
	"\x13total_output_amount\x18\x03 \x01(\tR\x11totalOutputAmount\x122\n" +
	...
	"\"PublishUnminedTransactionsResponse\"\x9d\x05\n" +
	"\x16PurchaseTicketsRequest\x12\x1e\n" +
	"\n" +
	"passphrase\x18\x01 \x01(\fR\n" +
	"passphrase\x12\x18\n" +
	"\aaccount\x18\x02 \x01(\rR\aaccount\x12\x1f\n" +
	"\vspend_limit\x18\x03 \x01(\x03R\n" +
	"spendLimit\x125\n" +
	"\x16required_confirmations\x18\x04 \x01(\rR\x15requiredConfirmations\x12\x1f\n" +
	"\vnum_tickets\x18\x05 \x01(\rR\n" +
	"numTickets\x12\x16\n" +
	"\x06expiry\x18\x06 \x01(\rR\x06expiry\x12\x15\n" +
	"\x06tx_fee\x18\a \x01(\x03R\x05txFee\x12\x1d\n" +
	"\n" +
	"ticket_fee\x18\b \x01(\x03R\tticketFee\x12 \n" +
	"\fdont_sign_tx\x18\t \x01(\bR\n" +
	"dontSignTx\x12#\n" +
	"\renable_mixing\x18\n" +
	" \x01(\bR\fenableMixing\x12#\n" +
	"\rmixed_account\x18\v \x01(\rR\fmixedAccount\x120\n" +
	"\x14mixed_account_branch\x18\f \x01(\rR\x12mixedAccountBranch\x12.\n" +
	"\x13mixed_split_account\x18\r \x01(\rR\x11mixedSplitAccount\x12%\n" +
	"\x0echange_account\x18\x0e \x01(\rR\rchangeAccount\x12\x19\n" +
	"\bvsp_host\x18\x0f \x01(\tR\avspHost\x12\x1d\n" +
	"\n" +
	"vsp_pubkey\x18\x10 \x01(\tR\tvspPubkey\x12,\n" +
	"\x12use_voting_account\x18\x11 \x01(\bR\x10useVotingAccount\x12%\n" +
	"\x0evoting_account\x18\x12 \x01(\rR\rvotingAccount\"s\n" +
	...
	"\x04hash\x18\x02 \x01(\fR\x04hash\"\xdf\x01\n" +
	...
	"\n" +
	"fee_per_kb\x18\x04 \x01(\tR\bfeePerKb\x12\x1b\n" +
	"\tcoin_type\x18\x05 \x01(\rR\bcoinType\"\xee\x01\n" +
	...
	"\x14DecodeRawTransaction\x12&.walletrpc.DecodeRawTransactionRequest\x1a'.walletrpc.DecodeRawTransactionResponseB,Z*github.com/monetarium/wallet/rpc/walletrpcb\x06proto3"
...
var file_api_proto_msgTypes = make([]protoimpl.MessageInfo, 223)
var file_api_proto_goTypes = []any{
	...
	nil,                                                                // 211: walletrpc.AccountsResponse.Account.SkaTotalBalancesEntry
	...
	(*TSpendPoliciesResponse_Policy)(nil),                              // 228: walletrpc.TSpendPoliciesResponse.Policy
	(*TreasuryPoliciesResponse_Policy)(nil),                            // 229: walletrpc.TreasuryPoliciesResponse.Policy
	...
	(*GetTrackedVSPTicketsResponse_Ticket)(nil),                        // 234: walletrpc.GetTrackedVSPTicketsResponse.Ticket
	(*GetTrackedVSPTicketsResponse_VSP)(nil),                           // 235: walletrpc.GetTrackedVSPTicketsResponse.VSP
}
var file_api_proto_depIdxs = []int32{
	...
	212, // 11: walletrpc.GetTicketsResponse.ticket:type_name -> walletrpc.GetTicketsResponse.TicketDetails
	213, // 12: walletrpc.GetTicketsResponse.block:type_name -> walletrpc.GetTicketsResponse.BlockDetails
	6,   // 13: walletrpc.ChangePassphraseRequest.key:type_name -> walletrpc.ChangePassphraseRequest.Key
	214, // 14: walletrpc.FundTransactionResponse.selected_outputs:type_name -> walletrpc.FundTransactionResponse.PreviousOutput
	...
	216, // 16: walletrpc.ConstructTransactionRequest.non_change_outputs:type_name -> walletrpc.ConstructTransactionRequest.Output
	215, // 17: walletrpc.ConstructTransactionRequest.change_destination:type_name -> walletrpc.ConstructTransactionRequest.OutputDestination
	217, // 18: walletrpc.SignTransactionRequest.additional_scripts:type_name -> walletrpc.SignTransactionRequest.AdditionalScript
	219, // 19: walletrpc.SignTransactionsRequest.transactions:type_name -> walletrpc.SignTransactionsRequest.UnsignedTransaction
	218, // 20: walletrpc.SignTransactionsRequest.additional_scripts:type_name -> walletrpc.SignTransactionsRequest.AdditionalScript
	220, // 21: walletrpc.SignTransactionsResponse.transactions:type_name -> walletrpc.SignTransactionsResponse.SignedTransaction
	8,   // 22: walletrpc.CreateSignatureRequest.hash_type:type_name -> walletrpc.CreateSignatureRequest.SigHashType
	221, // 23: walletrpc.SignMessagesRequest.messages:type_name -> walletrpc.SignMessagesRequest.Message
	222, // 24: walletrpc.SignMessagesResponse.replies:type_name -> walletrpc.SignMessagesResponse.SignReply
	...
	223, // 28: walletrpc.ConfirmationNotificationsResponse.confirmations:type_name -> walletrpc.ConfirmationNotificationsResponse.TransactionConfirmations
	...
	224, // 39: walletrpc.AgendasResponse.agendas:type_name -> walletrpc.AgendasResponse.Agenda
	226, // 40: walletrpc.VoteChoicesResponse.choices:type_name -> walletrpc.VoteChoicesResponse.Choice
	227, // 41: walletrpc.SetVoteChoicesRequest.choices:type_name -> walletrpc.SetVoteChoicesRequest.Choice
	228, // 42: walletrpc.TSpendPoliciesResponse.policies:type_name -> walletrpc.TSpendPoliciesResponse.Policy
	229, // 43: walletrpc.TreasuryPoliciesResponse.policies:type_name -> walletrpc.TreasuryPoliciesResponse.Policy
	1,   // 44: walletrpc.DecodedTransaction.transaction_type:type_name -> walletrpc.TransactionDetails.TransactionType
	230, // 45: walletrpc.DecodedTransaction.inputs:type_name -> walletrpc.DecodedTransaction.Input
	231, // 46: walletrpc.DecodedTransaction.outputs:type_name -> walletrpc.DecodedTransaction.Output
	...
	232, // 49: walletrpc.CommittedTicketsResponse.ticketAddresses:type_name -> walletrpc.CommittedTicketsResponse.TicketAddress
	178, // 50: walletrpc.GetCoinjoinOutputspByAcctResponse.data:type_name -> walletrpc.coinjoinTxsSumByAcct
	233, // 51: walletrpc.GetPeerInfoResponse.peer_info:type_name -> walletrpc.GetPeerInfoResponse.PeerInfo
	12,  // 52: walletrpc.GetVSPTicketsByFeeStatusRequest.fee_status:type_name -> walletrpc.GetVSPTicketsByFeeStatusRequest.FeeStatus
	235, // 53: walletrpc.GetTrackedVSPTicketsResponse.vsps:type_name -> walletrpc.GetTrackedVSPTicketsResponse.VSP
	211, // 54: walletrpc.AccountsResponse.Account.ska_total_balances:type_name -> walletrpc.AccountsResponse.Account.SkaTotalBalancesEntry
	15,  // 55: walletrpc.GetTicketsResponse.TicketDetails.ticket:type_name -> walletrpc.TransactionDetails
	15,  // 56: walletrpc.GetTicketsResponse.TicketDetails.spender:type_name -> walletrpc.TransactionDetails
	5,   // 57: walletrpc.GetTicketsResponse.TicketDetails.ticket_status:type_name -> walletrpc.GetTicketsResponse.TicketDetails.TicketStatus
	215, // 58: walletrpc.ConstructTransactionRequest.Output.destination:type_name -> walletrpc.ConstructTransactionRequest.OutputDestination
	225, // 59: walletrpc.AgendasResponse.Agenda.choices:type_name -> walletrpc.AgendasResponse.Choice
	9,   // 60: walletrpc.DecodedTransaction.Input.tree:type_name -> walletrpc.DecodedTransaction.Input.TreeType
	10,  // 61: walletrpc.DecodedTransaction.Output.script_class:type_name -> walletrpc.DecodedTransaction.Output.ScriptClass
	234, // 62: walletrpc.GetTrackedVSPTicketsResponse.VSP.tickets:type_name -> walletrpc.GetTrackedVSPTicketsResponse.Ticket
	13,  // 63: walletrpc.VersionService.Version:input_type -> walletrpc.VersionRequest
	19,  // 64: walletrpc.WalletService.Ping:input_type -> walletrpc.PingRequest
	21,  // 65: walletrpc.WalletService.Network:input_type -> walletrpc.NetworkRequest
	23,  // 66: walletrpc.WalletService.CoinType:input_type -> walletrpc.CoinTypeRequest
	25,  // 67: walletrpc.WalletService.AccountNumber:input_type -> walletrpc.AccountNumberRequest
	27,  // 68: walletrpc.WalletService.Accounts:input_type -> walletrpc.AccountsRequest
	29,  // 69: walletrpc.WalletService.Address:input_type -> walletrpc.AddressRequest
	51,  // 70: walletrpc.WalletService.Balance:input_type -> walletrpc.BalanceRequest
	158, // 71: walletrpc.WalletService.GetAccountExtendedPubKey:input_type -> walletrpc.GetAccountExtendedPubKeyRequest
	160, // 72: walletrpc.WalletService.GetAccountExtendedPrivKey:input_type -> walletrpc.GetAccountExtendedPrivKeyRequest
	53,  // 73: walletrpc.WalletService.GetTransaction:input_type -> walletrpc.GetTransactionRequest
	55,  // 74: walletrpc.WalletService.GetTransactions:input_type -> walletrpc.GetTransactionsRequest
	57,  // 75: walletrpc.WalletService.GetTicket:input_type -> walletrpc.GetTicketRequest
	58,  // 76: walletrpc.WalletService.GetTickets:input_type -> walletrpc.GetTicketsRequest
	60,  // 77: walletrpc.WalletService.TicketPrice:input_type -> walletrpc.TicketPriceRequest
	62,  // 78: walletrpc.WalletService.StakeInfo:input_type -> walletrpc.StakeInfoRequest
	64,  // 79: walletrpc.WalletService.BlockInfo:input_type -> walletrpc.BlockInfoRequest
	163, // 80: walletrpc.WalletService.BestBlock:input_type -> walletrpc.BestBlockRequest
	171, // 81: walletrpc.WalletService.Spender:input_type -> walletrpc.SpenderRequest
	173, // 82: walletrpc.WalletService.GetCFilters:input_type -> walletrpc.GetCFiltersRequest
	192, // 83: walletrpc.WalletService.GetPeerInfo:input_type -> walletrpc.GetPeerInfoRequest
	43,  // 84: walletrpc.WalletService.DumpPrivateKey:input_type -> walletrpc.DumpPrivateKeyRequest
	45,  // 85: walletrpc.WalletService.BirthBlock:input_type -> walletrpc.BirthBlockRequest
	92,  // 86: walletrpc.WalletService.TransactionNotifications:input_type -> walletrpc.TransactionNotificationsRequest
	94,  // 87: walletrpc.WalletService.AccountNotifications:input_type -> walletrpc.AccountNotificationsRequest
	96,  // 88: walletrpc.WalletService.ConfirmationNotifications:input_type -> walletrpc.ConfirmationNotificationsRequest
	66,  // 89: walletrpc.WalletService.ChangePassphrase:input_type -> walletrpc.ChangePassphraseRequest
	31,  // 90: walletrpc.WalletService.RenameAccount:input_type -> walletrpc.RenameAccountRequest
	33,  // 91: walletrpc.WalletService.Rescan:input_type -> walletrpc.RescanRequest
	35,  // 92: walletrpc.WalletService.NextAccount:input_type -> walletrpc.NextAccountRequest
	37,  // 93: walletrpc.WalletService.NextAddress:input_type -> walletrpc.NextAddressRequest
	39,  // 94: walletrpc.WalletService.ImportPrivateKey:input_type -> walletrpc.ImportPrivateKeyRequest
	41,  // 95: walletrpc.WalletService.ImportExtendedPublicKey:input_type -> walletrpc.ImportExtendedPublicKeyRequest
	47,  // 96: walletrpc.WalletService.ImportVotingAccountFromSeed:input_type -> walletrpc.ImportVotingAccountFromSeedRequest
	49,  // 97: walletrpc.WalletService.ImportScript:input_type -> walletrpc.ImportScriptRequest
	68,  // 98: walletrpc.WalletService.FundTransaction:input_type -> walletrpc.FundTransactionRequest
	70,  // 99: walletrpc.WalletService.UnspentOutputs:input_type -> walletrpc.UnspentOutputsRequest
	72,  // 100: walletrpc.WalletService.ConstructTransaction:input_type -> walletrpc.ConstructTransactionRequest
	74,  // 101: walletrpc.WalletService.SignTransaction:input_type -> walletrpc.SignTransactionRequest
	76,  // 102: walletrpc.WalletService.SignTransactions:input_type -> walletrpc.SignTransactionsRequest
	78,  // 103: walletrpc.WalletService.CreateSignature:input_type -> walletrpc.CreateSignatureRequest
	80,  // 104: walletrpc.WalletService.PublishTransaction:input_type -> walletrpc.PublishTransactionRequest
	82,  // 105: walletrpc.WalletService.PublishUnminedTransactions:input_type -> walletrpc.PublishUnminedTransactionsRequest
	84,  // 106: walletrpc.WalletService.PurchaseTickets:input_type -> walletrpc.PurchaseTicketsRequest
	86,  // 107: walletrpc.WalletService.LoadActiveDataFilters:input_type -> walletrpc.LoadActiveDataFiltersRequest
	88,  // 108: walletrpc.WalletService.SignMessage:input_type -> walletrpc.SignMessageRequest
	90,  // 109: walletrpc.WalletService.SignMessages:input_type -> walletrpc.SignMessagesRequest
	155, // 110: walletrpc.WalletService.ValidateAddress:input_type -> walletrpc.ValidateAddressRequest
	157, // 111: walletrpc.WalletService.CommittedTickets:input_type -> walletrpc.CommittedTicketsRequest
	165, // 112: walletrpc.WalletService.SweepAccount:input_type -> walletrpc.SweepAccountRequest
	167, // 113: walletrpc.WalletService.AbandonTransaction:input_type -> walletrpc.AbandonTransactionRequest
	169, // 114: walletrpc.WalletService.SignHashes:input_type -> walletrpc.SignHashesRequest
	177, // 115: walletrpc.WalletService.GetCoinjoinOutputspByAcct:input_type -> walletrpc.GetCoinjoinOutputspByAcctRequest
	180, // 116: walletrpc.WalletService.SetAccountPassphrase:input_type -> walletrpc.SetAccountPassphraseRequest
	181, // 117: walletrpc.WalletService.UnlockAccount:input_type -> walletrpc.UnlockAccountRequest
	182, // 118: walletrpc.WalletService.LockAccount:input_type -> walletrpc.LockAccountRequest
	188, // 119: walletrpc.WalletService.UnlockWallet:input_type -> walletrpc.UnlockWalletRequest
	190, // 120: walletrpc.WalletService.LockWallet:input_type -> walletrpc.LockWalletRequest
	186, // 121: walletrpc.WalletService.AccountUnlocked:input_type -> walletrpc.AccountUnlockedRequest
	194, // 122: walletrpc.WalletService.SyncVSPFailedTickets:input_type -> walletrpc.SyncVSPTicketsRequest
	196, // 123: walletrpc.WalletService.GetVSPTicketsByFeeStatus:input_type -> walletrpc.GetVSPTicketsByFeeStatusRequest
	198, // 124: walletrpc.WalletService.ProcessManagedTickets:input_type -> walletrpc.ProcessManagedTicketsRequest
	200, // 125: walletrpc.WalletService.ProcessUnmanagedTickets:input_type -> walletrpc.ProcessUnmanagedTicketsRequest
	202, // 126: walletrpc.WalletService.SetVspdVoteChoices:input_type -> walletrpc.SetVspdVoteChoicesRequest
	204, // 127: walletrpc.WalletService.GetTrackedVSPTickets:input_type -> walletrpc.GetTrackedVSPTicketsRequest
	206, // 128: walletrpc.WalletService.DiscoverUsage:input_type -> walletrpc.DiscoverUsageRequest
	106, // 129: walletrpc.WalletLoaderService.WalletExists:input_type -> walletrpc.WalletExistsRequest
	98,  // 130: walletrpc.WalletLoaderService.CreateWallet:input_type -> walletrpc.CreateWalletRequest
	100, // 131: walletrpc.WalletLoaderService.CreateWatchingOnlyWallet:input_type -> walletrpc.CreateWatchingOnlyWalletRequest
	102, // 132: walletrpc.WalletLoaderService.OpenWallet:input_type -> walletrpc.OpenWalletRequest
	104, // 133: walletrpc.WalletLoaderService.CloseWallet:input_type -> walletrpc.CloseWalletRequest
	124, // 134: walletrpc.WalletLoaderService.SpvSync:input_type -> walletrpc.SpvSyncRequest
	122, // 135: walletrpc.WalletLoaderService.RpcSync:input_type -> walletrpc.RpcSyncRequest
	126, // 136: walletrpc.WalletLoaderService.RescanPoint:input_type -> walletrpc.RescanPointRequest
	134, // 137: walletrpc.AccountMixerService.RunAccountMixer:input_type -> walletrpc.RunAccountMixerRequest
	132, // 138: walletrpc.TicketBuyerService.RunTicketBuyer:input_type -> walletrpc.RunTicketBuyerRequest
	128, // 139: walletrpc.SeedService.GenerateRandomSeed:input_type -> walletrpc.GenerateRandomSeedRequest
	130, // 140: walletrpc.SeedService.DecodeSeed:input_type -> walletrpc.DecodeSeedRequest
	136, // 141: walletrpc.AgendaService.Agendas:input_type -> walletrpc.AgendasRequest
	138, // 142: walletrpc.VotingService.VoteChoices:input_type -> walletrpc.VoteChoicesRequest
	140, // 143: walletrpc.VotingService.SetVoteChoices:input_type -> walletrpc.SetVoteChoicesRequest
	142, // 144: walletrpc.VotingService.TSpendPolicies:input_type -> walletrpc.TSpendPoliciesRequest
	144, // 145: walletrpc.VotingService.SetTSpendPolicy:input_type -> walletrpc.SetTSpendPolicyRequest
	146, // 146: walletrpc.VotingService.TreasuryPolicies:input_type -> walletrpc.TreasuryPoliciesRequest
	148, // 147: walletrpc.VotingService.SetTreasuryPolicy:input_type -> walletrpc.SetTreasuryPolicyRequest
	150, // 148: walletrpc.MessageVerificationService.VerifyMessage:input_type -> walletrpc.VerifyMessageRequest
	175, // 149: walletrpc.NetworkService.GetRawBlock:input_type -> walletrpc.GetRawBlockRequest
	153, // 150: walletrpc.DecodeMessageService.DecodeRawTransaction:input_type -> walletrpc.DecodeRawTransactionRequest
	14,  // 151: walletrpc.VersionService.Version:output_type -> walletrpc.VersionResponse
	20,  // 152: walletrpc.WalletService.Ping:output_type -> walletrpc.PingResponse
	22,  // 153: walletrpc.WalletService.Network:output_type -> walletrpc.NetworkResponse
	24,  // 154: walletrpc.WalletService.CoinType:output_type -> walletrpc.CoinTypeResponse
	26,  // 155: walletrpc.WalletService.AccountNumber:output_type -> walletrpc.AccountNumberResponse
	28,  // 156: walletrpc.WalletService.Accounts:output_type -> walletrpc.AccountsResponse
	30,  // 157: walletrpc.WalletService.Address:output_type -> walletrpc.AddressResponse
	52,  // 158: walletrpc.WalletService.Balance:output_type -> walletrpc.BalanceResponse
	159, // 159: walletrpc.WalletService.GetAccountExtendedPubKey:output_type -> walletrpc.GetAccountExtendedPubKeyResponse
	161, // 160: walletrpc.WalletService.GetAccountExtendedPrivKey:output_type -> walletrpc.GetAccountExtendedPrivKeyResponse
	54,  // 161: walletrpc.WalletService.GetTransaction:output_type -> walletrpc.GetTransactionResponse
	56,  // 162: walletrpc.WalletService.GetTransactions:output_type -> walletrpc.GetTransactionsResponse
	59,  // 163: walletrpc.WalletService.GetTicket:output_type -> walletrpc.GetTicketsResponse
	59,  // 164: walletrpc.WalletService.GetTickets:output_type -> walletrpc.GetTicketsResponse
	61,  // 165: walletrpc.WalletService.TicketPrice:output_type -> walletrpc.TicketPriceResponse
	63,  // 166: walletrpc.WalletService.StakeInfo:output_type -> walletrpc.StakeInfoResponse
	65,  // 167: walletrpc.WalletService.BlockInfo:output_type -> walletrpc.BlockInfoResponse
	164, // 168: walletrpc.WalletService.BestBlock:output_type -> walletrpc.BestBlockResponse
	172, // 169: walletrpc.WalletService.Spender:output_type -> walletrpc.SpenderResponse
	174, // 170: walletrpc.WalletService.GetCFilters:output_type -> walletrpc.GetCFiltersResponse
	193, // 171: walletrpc.WalletService.GetPeerInfo:output_type -> walletrpc.GetPeerInfoResponse
	44,  // 172: walletrpc.WalletService.DumpPrivateKey:output_type -> walletrpc.DumpPrivateKeyResponse
	46,  // 173: walletrpc.WalletService.BirthBlock:output_type -> walletrpc.BirthBlockResponse
	93,  // 174: walletrpc.WalletService.TransactionNotifications:output_type -> walletrpc.TransactionNotificationsResponse
	95,  // 175: walletrpc.WalletService.AccountNotifications:output_type -> walletrpc.AccountNotificationsResponse
	97,  // 176: walletrpc.WalletService.ConfirmationNotifications:output_type -> walletrpc.ConfirmationNotificationsResponse
	67,  // 177: walletrpc.WalletService.ChangePassphrase:output_type -> walletrpc.ChangePassphraseResponse
	32,  // 178: walletrpc.WalletService.RenameAccount:output_type -> walletrpc.RenameAccountResponse
	34,  // 179: walletrpc.WalletService.Rescan:output_type -> walletrpc.RescanResponse
	36,  // 180: walletrpc.WalletService.NextAccount:output_type -> walletrpc.NextAccountResponse
	38,  // 181: walletrpc.WalletService.NextAddress:output_type -> walletrpc.NextAddressResponse
	40,  // 182: walletrpc.WalletService.ImportPrivateKey:output_type -> walletrpc.ImportPrivateKeyResponse
	42,  // 183: walletrpc.WalletService.ImportExtendedPublicKey:output_type -> walletrpc.ImportExtendedPublicKeyResponse
	48,  // 184: walletrpc.WalletService.ImportVotingAccountFromSeed:output_type -> walletrpc.ImportVotingAccountFromSeedResponse
	50,  // 185: walletrpc.WalletService.ImportScript:output_type -> walletrpc.ImportScriptResponse
	69,  // 186: walletrpc.WalletService.FundTransaction:output_type -> walletrpc.FundTransactionResponse
	71,  // 187: walletrpc.WalletService.UnspentOutputs:output_type -> walletrpc.UnspentOutputResponse
	73,  // 188: walletrpc.WalletService.ConstructTransaction:output_type -> walletrpc.ConstructTransactionResponse
	75,  // 189: walletrpc.WalletService.SignTransaction:output_type -> walletrpc.SignTransactionResponse
	77,  // 190: walletrpc.WalletService.SignTransactions:output_type -> walletrpc.SignTransactionsResponse
	79,  // 191: walletrpc.WalletService.CreateSignature:output_type -> walletrpc.CreateSignatureResponse
	81,  // 192: walletrpc.WalletService.PublishTransaction:output_type -> walletrpc.PublishTransactionResponse
	83,  // 193: walletrpc.WalletService.PublishUnminedTransactions:output_type -> walletrpc.PublishUnminedTransactionsResponse
	85,  // 194: walletrpc.WalletService.PurchaseTickets:output_type -> walletrpc.PurchaseTicketsResponse
	87,  // 195: walletrpc.WalletService.LoadActiveDataFilters:output_type -> walletrpc.LoadActiveDataFiltersResponse
	89,  // 196: walletrpc.WalletService.SignMessage:output_type -> walletrpc.SignMessageResponse
	91,  // 197: walletrpc.WalletService.SignMessages:output_type -> walletrpc.SignMessagesResponse
	156, // 198: walletrpc.WalletService.ValidateAddress:output_type -> walletrpc.ValidateAddressResponse
	162, // 199: walletrpc.WalletService.CommittedTickets:output_type -> walletrpc.CommittedTicketsResponse
	166, // 200: walletrpc.WalletService.SweepAccount:output_type -> walletrpc.SweepAccountResponse
	168, // 201: walletrpc.WalletService.AbandonTransaction:output_type -> walletrpc.AbandonTransactionResponse
	170, // 202: walletrpc.WalletService.SignHashes:output_type -> walletrpc.SignHashesResponse
	179, // 203: walletrpc.WalletService.GetCoinjoinOutputspByAcct:output_type -> walletrpc.GetCoinjoinOutputspByAcctResponse
	183, // 204: walletrpc.WalletService.SetAccountPassphrase:output_type -> walletrpc.SetAccountPassphraseResponse
	184, // 205: walletrpc.WalletService.UnlockAccount:output_type -> walletrpc.UnlockAccountResponse
	185, // 206: walletrpc.WalletService.LockAccount:output_type -> walletrpc.LockAccountResponse
	189, // 207: walletrpc.WalletService.UnlockWallet:output_type -> walletrpc.UnlockWalletResponse
	191, // 208: walletrpc.WalletService.LockWallet:output_type -> walletrpc.LockWalletResponse
	187, // 209: walletrpc.WalletService.AccountUnlocked:output_type -> walletrpc.AccountUnlockedResponse
	195, // 210: walletrpc.WalletService.SyncVSPFailedTickets:output_type -> walletrpc.SyncVSPTicketsResponse
	197, // 211: walletrpc.WalletService.GetVSPTicketsByFeeStatus:output_type -> walletrpc.GetVSPTicketsByFeeStatusResponse
	199, // 212: walletrpc.WalletService.ProcessManagedTickets:output_type -> walletrpc.ProcessManagedTicketsResponse
	201, // 213: walletrpc.WalletService.ProcessUnmanagedTickets:output_type -> walletrpc.ProcessUnmanagedTicketsResponse
	203, // 214: walletrpc.WalletService.SetVspdVoteChoices:output_type -> walletrpc.SetVspdVoteChoicesResponse
	205, // 215: walletrpc.WalletService.GetTrackedVSPTickets:output_type -> walletrpc.GetTrackedVSPTicketsResponse
	207, // 216: walletrpc.WalletService.DiscoverUsage:output_type -> walletrpc.DiscoverUsageResponse
	107, // 217: walletrpc.WalletLoaderService.WalletExists:output_type -> walletrpc.WalletExistsResponse
	99,  // 218: walletrpc.WalletLoaderService.CreateWallet:output_type -> walletrpc.CreateWalletResponse
	101, // 219: walletrpc.WalletLoaderService.CreateWatchingOnlyWallet:output_type -> walletrpc.CreateWatchingOnlyWalletResponse
	103, // 220: walletrpc.WalletLoaderService.OpenWallet:output_type -> walletrpc.OpenWalletResponse
	105, // 221: walletrpc.WalletLoaderService.CloseWallet:output_type -> walletrpc.CloseWalletResponse
	125, // 222: walletrpc.WalletLoaderService.SpvSync:output_type -> walletrpc.SpvSyncResponse
	123, // 223: walletrpc.WalletLoaderService.RpcSync:output_type -> walletrpc.RpcSyncResponse
	127, // 224: walletrpc.WalletLoaderService.RescanPoint:output_type -> walletrpc.RescanPointResponse
	135, // 225: walletrpc.AccountMixerService.RunAccountMixer:output_type -> walletrpc.RunAccountMixerResponse
	133, // 226: walletrpc.TicketBuyerService.RunTicketBuyer:output_type -> walletrpc.RunTicketBuyerResponse
	129, // 227: walletrpc.SeedService.GenerateRandomSeed:output_type -> walletrpc.GenerateRandomSeedResponse
	131, // 228: walletrpc.SeedService.DecodeSeed:output_type -> walletrpc.DecodeSeedResponse
	137, // 229: walletrpc.AgendaService.Agendas:output_type -> walletrpc.AgendasResponse
	139, // 230: walletrpc.VotingService.VoteChoices:output_type -> walletrpc.VoteChoicesResponse
	141, // 231: walletrpc.VotingService.SetVoteChoices:output_type -> walletrpc.SetVoteChoicesResponse
	143, // 232: walletrpc.VotingService.TSpendPolicies:output_type -> walletrpc.TSpendPoliciesResponse
	145, // 233: walletrpc.VotingService.SetTSpendPolicy:output_type -> walletrpc.SetTSpendPolicyResponse
	147, // 234: walletrpc.VotingService.TreasuryPolicies:output_type -> walletrpc.TreasuryPoliciesResponse
	149, // 235: walletrpc.VotingService.SetTreasuryPolicy:output_type -> walletrpc.SetTreasuryPolicyResponse
	151, // 236: walletrpc.MessageVerificationService.VerifyMessage:output_type -> walletrpc.VerifyMessageResponse
	176, // 237: walletrpc.NetworkService.GetRawBlock:output_type -> walletrpc.GetRawBlockResponse
	154, // 238: walletrpc.DecodeMessageService.DecodeRawTransaction:output_type -> walletrpc.DecodeRawTransactionResponse
	151, // [151:239] is the sub-list for method output_type
	63,  // [63:151] is the sub-list for method input_type
